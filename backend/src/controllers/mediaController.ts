...
// Get a presigned PUT URL so the client can upload directly to storage.
...
// Save photo metadata after the client finishes uploading, then kick off thumbnail generation.
...
// Get photo metadata and a signed download URL.
...
// Delete photo metadata and the corresponding stored objects.
